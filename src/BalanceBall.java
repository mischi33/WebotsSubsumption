public class BalanceBall extends Behaviour {
    ...
    public boolean activatable() {
        return controller.getDistanceSensor("ps0").getValue() > 100 || controller.getDistanceSensor("ps7").getValue() > 100;
    }
   ...
   if (controller.getDistanceSensor("ps7").getValue() > 100 && controller.getDistanceSensor("ps0").getValue() > 150) {
            controller.saveMove(new double[] {-800, -800});
            return new double[]{800, 800};
        } else if (controller.getDistanceSensor("ps1").getValue() > 100 || controller.getDistanceSensor("ps0").getValue() > 100) {
            controller.saveMove(new double[] {-800, 0});
            return new double[]{800, 0};
        } else if (controller.getDistanceSensor("ps6").getValue() > 100 || controller.getDistanceSensor("ps7").getValue() > 100) {
